                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                    ...
                    <div class="md:col-span-3 relative group">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-400 group-focus-within:text-blue-500"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A7.5 7.5 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                            </svg>
                        </div>
                    ...
                    <div class="md:col-span-2 relative group">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-400 group-focus-within:text-blue-500"
                                ...
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5-3.9 19.5" />
                            </svg>
                        </div>
        ...
        <x-modal.form-modal :formTitle="$member_id ? 'Edit Member' : 'Add Member'" action="store()">
            <div class="py-4 md:py-6">
                ...
                <div class="grid grid-cols-1 gap-2 mb-4 border-b p-4 shadow-sm rounded-md bg-white">
                    ...
                    <div>
                        <x-modal.input name="name" label="Name" type="text" placeholder="John Doe"
                            required />
                    </div>
                    <div>
        ...
        <x-modal.form-modal :formTitle="'Withdrawal'" action="processWithdrawal()" :height="'h-auto'">
            <div class="py-4 px-2 md:py-6">
                ...
                <div class="mb-0">
                    ...
                    <input name="payment_receipt" id="file" wire:model="payment_receipt"
                        class="cursor-pointer bg-slate-50 border border-stone-500 text-heading text-sm rounded-md focus:ring-stone focus:border-stone block w-full shadow-xs placeholder:text-body p-2"
                        type="file">
